...
public class JsonUser
{
    ...
    public List<JsonTag> Tags { get; set; } = new List<JsonTag>();
    public List<JsonAccount> Accounts { get; set; } = new List<JsonAccount>();
...
public class JsonAccount
{
    ...
    public List<long> Fields { get; set; } = new List<long>();
}
public class JsonTag
{
    ...
    [MaxLength(96)]
    public byte[] TagColorString { get; set; }
}
